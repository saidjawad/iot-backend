...
def execute_pattern_search_in_censys_certs(env_file):
    ...
    domain_search_path = project_dir.joinpath(Path(getenv('CENSYS_PATTERN_LIST_PATH')))
    ...
    for input_file_path in input_files:
        job = CensysCertificatePatternSearchExperimentJob(input_file_path, domain_search_path)
...
if __name__ == "__main__":
    execute_pattern_search_in_censys_certs()
